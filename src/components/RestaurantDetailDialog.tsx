...
export function RestaurantDetailDialog({ restaurant, open, onOpenChange }: RestaurantDetailDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl w-[95vw] max-h-[95vh] overflow-hidden flex flex-col p-0 sm:rounded-lg">
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain p-6 space-y-6" style={{ scrollBehavior: 'smooth' }}>
          {/* 基本信息 */}
