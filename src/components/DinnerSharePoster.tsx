...
export const DinnerSharePoster = ({ dinner, participantCount, hostName, open, onOpenChange }: DinnerSharePosterProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md p-0 overflow-hidden max-h-[85vh] flex flex-col !top-[50%] !translate-y-[-50%] data-[state=closed]:!slide-out-to-top-[50%] data-[state=open]:!slide-in-from-top-[50%]">
